...
{
    public class TiledMapEffect : Effect, IEffectMatrices
    {
        ...
        static readonly String resourceName = "tainicom.Aether.Shaders.Resources.TiledMapEffect.dx11.mgfxo";
#else
        static readonly String resourceName = "tainicom.Aether.Shaders.Resources.TiledMapEffect.xna.WinReach";
#endif
        ...
        internal static Stream LoadEffectResourceStream(string name)
        {
            ...
            Stream stream = GetAssembly(typeof(TiledMapEffect)).GetManifestResourceStream(name);
            return stream;
        }
        ...
        public TiledMapEffect(GraphicsDevice graphicsDevice, byte[] Bytecode): base(graphicsDevice, Bytecode)
        {   
            CacheEffectParameters(null);
        }

        protected TiledMapEffect(TiledMapEffect cloneSource)
            : base(cloneSource)
        {
        ...
        {
            return new TiledMapEffect(this);
        }

        void CacheEffectParameters(TiledMapEffect cloneSource)
        {   
